...
<?php $this->beginBody() ?>
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="#"><img src="<?= $bundle->baseUrl.'/img/sedna-logo.png' ?>" alt="Sedna logo"></a></div>
    ...
    <section class="features section-padding" id="features">
        ...
        <div class="responsive-feature-img"><img src="<?= $bundle->baseUrl.'/img/devices.png'?>" alt="responsive devices"></div>
    </section>
    <section class="features-extra section-padding" id="assets">
        ...
        <div class="responsive-feature-img"><img src="<?= $bundle->baseUrl.'/img/macbook-pro.png'?>" alt="responsive devices"></div>
    </section>
    <section class="hero-strip section-padding">
        <div class="container">
            <div class="col-md-12 text-center">
                ...
                <div class="logo-placeholder floating-logo"></div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="<?= $bundle->baseUrl.'/img/blog-img-01.jpg'?>" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="<?= $bundle->baseUrl.'/img/blog-img-01.jpg'?>" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="<?= $bundle->baseUrl.'/img/blog-img-02.jpg'?>" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="<?= $bundle->baseUrl.'/img/blog-img-02.jpg'?>" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                ...
                <div class="col-md-4">
                    <article class="blog-post">
                        <figure>
                            <a href="<?= $bundle->baseUrl.'/img/blog-img-03.jpg'?>" class="single_image">
                                <div class="blog-img-wrap">
                                    <div class="overlay">
                                        <i class="fa fa-search"></i>
                                    </div>
                                    <img src="<?= $bundle->baseUrl.'/img/blog-img-03.jpg'?>" class="single_image" alt="Sedna blog image"/>
                                </div>
                            </a>
                            <figcaption>
                            <h2><a href="#" class="blog-category" data-toggle="tooltip" data-placement="top" data-original-title="See more posts">Product</a></h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                <div class="avatar"><img src="<?= $bundle->baseUrl.'/img/avatar.jpg'?>" alt="Sedna Testimonial Avatar"></div>
                                <h2>"Lorem ipsum dolor sit amet, nullam lucia nisi."</h2>
                                <p class="author">Peter Finlan, Product Designer.</p>
                            </li>
                            <li>
                                <div class="avatar"><img src="<?= $bundle->baseUrl.'/img/mani.jpg'?>" alt="Sedna Testimonial Avatar"></div>
                                <h2>"Nunc vel maximus purus. Nullam ac urna ornare."</h2>
                                <p class="author">Manoela Ilic, Founder @ Codrops.</p>
                            </li>
                            <li>
                                <div class="avatar"><img src="<?= $bundle->baseUrl.'/img/130.jpg'?>" alt="Sedna Testimonial Avatar"></div>
